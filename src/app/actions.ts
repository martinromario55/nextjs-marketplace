  ...
  const session = await stripe.checkout.sessions.create({
    ...
    success_url:
      process.env.NODE_ENV === "development"
        ...
        : "https://nextjs-marketplace-wheat.vercel.app/payment/success",
    cancel_url:
      process.env.NODE_ENV === "development"
        ? "http://localhost:3000/payment/cancel"
        : "https://nextjs-marketplace-wheat.vercel.app/payment/cancel",
  });
  ...
  const accountLink = await stripe.accountLinks.create({
    ...
    refresh_url:
      process.env.NODE_ENV === "development"
        ...
        : `https://nextjs-marketplace-wheat.vercel.app/billing`,
    return_url:
      process.env.NODE_ENV === "development"
        ? `http://localhost:3000/return/${data?.connectedAccountId}`
        : `https://nextjs-marketplace-wheat.vercel.app/return/${data?.connectedAccountId}`,
